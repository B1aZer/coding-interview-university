...
https://github.com/users/B1aZer/projects/1
...
- ### Linked Lists [x]
    ...
    - [x] implement (I did with tail pointer & without):
        - [x] in js - https://jsfiddle.net/b1azer/nwfj716h/65/
        ...
        - [x] value_n_from_end(n) - returns the value of the node at nth position from the end of the list. Keep 2 pointers (current, mOffs), set coffent offset from start to m, then increment from current to end (and mOffs), at the end mOffs is right element.
...
- [x] Notes:
    ...
    - binary tree sort, nlogn, stable, n memory
    - You can modify data forehead to optimize sorting alorithm
...
- [x] [Sedgewick - Mergesort (5 videos)](https://www.coursera.org/learn/algorithms-part1/home/week/3)
    - js: https://jsfiddle.net/b1azer/3v1ze0ga/117/
...
- [x] [Sedgewick - Quicksort (4 videos)](https://www.coursera.org/learn/algorithms-part1/home/week/3)
    - js: https://jsfiddle.net/b1azer/dr4Lbywx/46/
...
- [x] Insertion Sort
    - js: https://jsfiddle.net/b1azer/q2vs6Lhf/96/
...
- **Josephus problem**
-   - My solution through linked lists: https://jsfiddle.net/b1azer/x5qvdkbh/141/
-   - My solution through math indution: https://jsfiddle.net/b1azer/1h86sk5w/7/
